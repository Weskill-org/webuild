...
const EarningsChart = memo(function EarningsChart({ transactions }: EarningsChartProps) {
  // ⚡ Bolt Optimization: Memoize data derivation and wrap in React.memo
  // 🎯 Why: Recharts and date parsing are computationally expensive. Dashboard updates frequently on search keystrokes.
  // 📊 Impact: Prevents massive SVG recalculations and blocks main thread lag during typing by skipping re-renders.
