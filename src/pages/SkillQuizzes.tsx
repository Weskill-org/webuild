...
export default function SkillQuizzes() {
  ...
  // ⚡ Bolt: Consolidate multiple O(N) filters into a single pass and memoize to avoid recalculation on timer tick re-renders
  const paletteCounts = useMemo(() => {
    return Object.values(paletteStatuses).reduce((acc, s) => {
