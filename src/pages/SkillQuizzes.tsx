...
export default function SkillQuizzes() {
  ...
  // Memoized Status Counts to avoid O(5n) recalculation on every timer tick
  ...
  if (activeQuiz && examMode === "active") {
    ...
    // Counting for Palette Status Legend is memoized at the top level to avoid re-renders on timer ticks
