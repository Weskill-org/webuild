      ...
      <DashboardLayout>
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b">
            <Button variant="ghost" size="icon" onClick={() => { setActiveQuiz(null); setExamMode("list"); }} aria-label="Go back to quiz list">
      ...
      <DashboardLayout>
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between border-b pb-4 flex-wrap gap-3">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" onClick={() => { setActiveQuiz(null); setActiveAttempt(null); setExamMode("list"); }} aria-label="Go back to quiz list">
                <ArrowLeft className="w-5 h-5" />
              </Button>
              <div>
                <h1 className="text-2xl font-bold">{activeQuiz.title}</h1>
