...
export default function SkillQuizzes() {
  ...
  // ⚡ Bolt Optimization: Counting for Palette Status Legend
  // Replaced 5 unmemoized O(n) filter passes inside the render cycle
  // with a single O(n) reduce loop wrapped in useMemo.
