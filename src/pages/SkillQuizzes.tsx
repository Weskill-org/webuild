...
export default function SkillQuizzes() {
  ...
  // ⚡ Bolt: Consolidated multiple array filters into a single memoized reduce pass to prevent O(5*N) recalculations on every timer tick.
  const paletteCounts = useMemo(() => {
    if (examMode !== "active") return { answered: 0, not_answered: 0, marked: 0, answered_marked: 0, not_visited: 0 };
