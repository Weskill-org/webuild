...
export default function AdminReferrals() {
  ...
  // ⚡ Bolt: Consolidated O(n) array iterations into a single useMemo loop
  ...
  // ⚡ Bolt: Memoized search filter and hoisted string processing
  const filtered = useMemo(() => {
    ...
    return referrals.filter((r) => {
      ...
      return referrerName.toLowerCase().includes(searchLower) ||
             referredName.toLowerCase().includes(searchLower) ||
